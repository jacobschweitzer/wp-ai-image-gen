...
const generateImage = async (prompt, provider, callback) => {
  // This function handles image generation using the WordPress API.
  try {
  ...
  return props => {
    ...
    const handleRegenerateImage = async () => {
      ...
      try {
        ...
        wp.data.dispatch('core/notices').createErrorNotice('Failed to regenerate image: ' + (err.message || 'Unknown error'), {
          type: 'snackbar'
        });
      } finally {
