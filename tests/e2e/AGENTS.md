...
- Modal controls for prompt, provider, orientation, and interactive refinement.
...
- Duplicate submission prevention, keyboard access, narrow viewports, and low-capability authorization.
- Premium Image Agent package generation and insertion.
